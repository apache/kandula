...
import org.apache.ws.transaction.utility.AttributedURI;
...
public class CoordinationContext {
	...
	CoordinationContextType ctx;

	public CoordinationContext(CoordinationContextType ctx) {
		this.ctx= ctx;
	}
	...
	public CoordinationContext(
		...
		ctx= new CoordinationContextType();
		ctx.setIdentifier(new AttributedURI(identifier.toString()));
	...
	public CoordinationContext(SOAPElement el) {
		...
		try {			
			...
			ctx.setIdentifier(new AttributedURI(TextExtractor.getText(node)));
	...
	public CoordinationContextType toCoordinationContextType() {
		return ctx;
	}
