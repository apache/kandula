...
public class EndpointReferenceFactory {
	...
	public EndpointReference getEndpointReference(PortType portType, ReferencePropertiesType referenceProperties) {
		String path= properties.getProperty(portType.getLocalPart());
		try {
			EndpointReference endpointReference= new EndpointReference(location + path);
