 ...
 *
 */
public interface ParticipantCompleteResult {
	/**
	 * Automatically report COMPLETED
	 */
	public static final ParticipantResultCompleted COMPLETED = ParticipantResultCompleted.instance;
