...
import org.apache.kandula.wsba.BusinessAgreementWithCoordinatorCompletionCoordinatorPortTypeBindingStub;

/**
 * Convenience Wrapper around BusinessAgreementWithCoordinatorCompletionCoordinatorPortTypeBindingStub
 * 
 * @author Hannes Erven, Georg Hicker (C) 2006
 *
 */
public class BAwPCCoordinatorStub extends
		BusinessAgreementWithCoordinatorCompletionCoordinatorPortTypeBindingStub
	...
	/**
	 * Constructor.
	 * @param epr The peer's endpoint.
	 * @throws AxisFault AxisFault.
	 * @throws MalformedURLException URL error.
	 */
	public BAwPCCoordinatorStub(final EndpointReference epr) throws AxisFault,
