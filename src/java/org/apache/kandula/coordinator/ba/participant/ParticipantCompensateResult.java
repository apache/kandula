 ...
 * onCompensate event handler.
 * 
 * @author Hannes Erven, Georg Hicker (C) 2006
 *
 */
public interface ParticipantCompensateResult {
	
	/**
	 * Automatically report COMPENSATED
	 */
	public static final ParticipantResultCompensated COMPENSATED = ParticipantResultCompensated.instance;

	/**
	 * Automatically report FAULTED
	 */
	public static final ParticipantResultFaulted FAULTED = ParticipantResultFaulted.instance;
